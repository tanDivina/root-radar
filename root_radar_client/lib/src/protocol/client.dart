...
/// {@category Endpoint}
class EndpointGarden extends _i2.EndpointRef {
  EndpointGarden(_i2.EndpointCaller caller) : super(caller);
  ...
  _i3.Future<void> deletePlant(int id) => caller.callServerEndpoint<void>(
    'garden',
    'deletePlant',
    {'id': id},
  );
